...
const TestimonialSection = () => {
  ...
  return (
   <section className='py-16 px-4 max-w-7xl mx-auto' id='testomonia'>
<div className='text-center mb-12'>
    <h2 className='text-3xl font-bold md:text-4xl mb-4'> What our happy clint say</h2>
    <p className='text-gray-600'>Think tast make it the best plac to start trading</p>
</div>
{/* Testimonial Casrd */}
<div className='relative'>
 ...
 <Swiper
       ...
       0: {
        ...
        modules={[Navigation]}
        className="testimonials-swiper md:mb-22"
      >
     {
        ...
        <SwiperSlide key={index} className='h-full md:py-12 py-4' >
          <div className='text-center bg-white p-4 rounded-lg shadow-md h-full flex flex-col'>
            <div className='w-24 h-24 mx-auto mb-4'>
              <img className='w-full h-full object-cover rounded-full' src={testimonal.image} alt="" />
            </div>
            <div className='flex justify-center mb-2'>
              {
                [...Array(5)].map((_,starIndex)=>
                <span className='text-yellow-600 text-3xl' key={starIndex}>★</span>
                )
              }
            </div>
          <h1 className=' text-xl font-semibold mb-3 '> {testimonal.name}</h1>
